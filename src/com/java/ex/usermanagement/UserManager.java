...
public class UserManager extends JFrame {
	...
	ArrayList<JLabel> lblNicknList = new ArrayList<JLabel>();
	...
	public UserManager() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (delete == JOptionPane.YES_OPTION) {
							...
							for (int i = index; i < lblIDList.size(); i++) {
								...
								TelPoint.y -= 55;
								Point NicknPoint = lblNicknList.get(i).getLocation();
								NicknPoint.y -= 55;
								...
								lblNicknList.get(i).setLocation(NicknPoint);
		...
		JButton btnAddmember = new JButton("고객 추가");
